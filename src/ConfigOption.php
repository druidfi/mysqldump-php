...
class ConfigOption
{
    ...
    public const string INCLUDE_TABLES = 'include-tables';

    #[DefaultValue(value: [], description: 'Tables to exclude from the dump')]
    #[Constraint(message: 'Must be an array of table names')]
    public const string EXCLUDE_TABLES = 'exclude-tables';
    ...
    public const string INIT_COMMANDS = 'init_commands';
    ...
    public const string DEFAULT_CHARACTER_SET = 'default-character-set';

    #[DefaultValue(value: true, description: 'Disable key checks during import')]
    public const string DISABLE_KEYS = 'disable-keys';

    #[DefaultValue(value: true, description: 'Use extended INSERT syntax')]
    public const string EXTENDED_INSERT = 'extended-insert';
    ...
    public const string HEX_BLOB = 'hex-blob';
    ...
    public const string NET_BUFFER_LENGTH = 'net_buffer_length';

    #[DefaultValue(value: true, description: 'Disable autocommit during import')]
    public const string NO_AUTOCOMMIT = 'no-autocommit';

    #[DefaultValue(value: false, description: 'Skip CREATE statements')]
    public const string NO_CREATE_INFO = 'no-create-info';
    ...
    public const string SINGLE_TRANSACTION = 'single-transaction';

    #[DefaultValue(value: false, description: 'Skip triggers')]
    public const string SKIP_TRIGGERS = 'skip-triggers';

    #[DefaultValue(value: false, description: 'Skip timezone UTC setting')]
    public const string SKIP_TZ_UTC = 'skip-tz-utc';

    #[DefaultValue(value: false, description: 'Skip comments in output')]
    public const string SKIP_COMMENTS = 'skip-comments';

    #[DefaultValue(value: false, description: 'Skip dump date in comments')]
    public const string SKIP_DUMP_DATE = 'skip-dump-date';
